    ...
    $(function(){
       $("#guruShowAll").edatagrid({
           ...
           toolbar:[
               ...
               {iconCls:'icon-cancel', text:'DELETE',handler:deleteguru},
               {iconCls:'icon-edit', text:'UPDATE',handler:updateguru},
               {iconCls:'icon-save', text:'SAVE',handler:save},
           ...
           columns:[[
               ...
               {field:'guruStatus',title:'状态',width:'25%',align:'center',editor:{type:'validatebox',options:{required:true}}},
           ]],
